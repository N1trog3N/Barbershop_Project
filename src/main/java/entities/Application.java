...
public class Application {
    ...
    public static boolean registerUser(String username, String password, boolean isAdmin, boolean isBarber) {
        ...
        if (isAdmin) {
            ...
            newUser = UserFactory.createBarber("barber", "barber", username, password);
        } else {
    ...
    public static void displayFunctionality() {
        ...
        if (currentUser instanceof Barber) {
            System.out.println("Additional Barber Functionality");
        }
