...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Application.registerUser("barber", "barber", false, true);
        ...
        while (isRunning) {
            ...
            System.out.println("4. Бронирование услуги барбершопа");
    ...
    private static void newRecordMenu(){
        if (Application.getUser(currentUser.getUsername()) instanceof Client) {
            ...
            if (record != null) {
                ...
                System.out.println("Барбер: " + record.getBarberName());
                System.out.println("Адрес барбершопа: " + record.getAddress());
            } else {
